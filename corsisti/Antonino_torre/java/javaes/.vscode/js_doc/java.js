    ...
    */
    ...
    for(i=1;i<=50;i++){
        ...
        */
        ...
        punteggio1=numeroRandom ("giocatore 1")
        punteggio2=numeroRandom ("giocatore 2")
        if (punteggio1>punteggio2){
            console.log ("vince giocatore 1")
        }
        else (console.log("vince giocatore 2"))
        */
        /*
        ...
        let giocatore2 = 0
        function numeroRandom(nome){
            let numeroRandom = Math.floor(Math.random()*(20-1+1)+1)
            return numeroRandom
        }
        ...
        for(i=0; i<tiri; i++){
            giocatore1 += numeroRandom("Giocatore1")
        }
        console.log(giocatore1)
        for(i=0; i<tiri; i++){
            console.log("Giocata 2o giocatore "+numeroRandom("Giocatore 2"))
            giocatore2 += numeroRandom("giocatore2")
        }
        ...
        */
        ...
        calciatore("stronzo",10,2,3,1,3,0)
        */
        // esercizio 36 
        ...
        function myLog(aCazzo,stringaDaFormattare2){
            ciaoMondo= stringaDaFormattare2 (aCazzo)
        }
