...
const modaleSchedaPersonaggio = new bootstrap.Modal(
  document.getElementById("modale-personaggio"),
  {}
);
...
function stampaCard(personaggioSingolo) {
  console.log("personaggioSingolo", personaggioSingolo);
  let divContainerCardElement = document.createElement("div");
  divContainerCardElement.classList.add(
    "col-12",
    "col-sm-6",
    "col-md-4",
    "col-lg-3"
